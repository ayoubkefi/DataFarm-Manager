...
class CollectionItemService :
    ...
    def create_collection_item(self, data:CollectionItemCreate) -> CollectionItemRead :
    ...
    def list_collection_items(self) -> list[CollectionItem] :
        collection_items = self.db.query(CollectionItem).all()
        return collection_items
    
    def get_collection_item(self, collection_item_name: str) -> CollectionItemRead:
